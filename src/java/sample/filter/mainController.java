...
public class mainController implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            String url = "LoadPlantServlet";
            HttpServletRequest req = (HttpServletRequest) request;
            String path = req.getRequestURI();
            url = path.substring(path.lastIndexOf("/") + 1);
            if (url.isEmpty()) {
                url = "LoadPlantServlet";
            } else if (!url.contains(".jsp") && !url.contains(".html") && !url.contains(".css") && !url.contains(".woff") && !url.contains(".jpg") && !url.contains(".png") && !url.contains(".js")) {
                url = url + "Servlet";
            }
            if (url != null) {
